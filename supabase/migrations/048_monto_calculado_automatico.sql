-- ConCasa CRM — monto_calculado automático con base fija $3,000
-- P048: revierte captura manual P046; fórmula (monto_aprobado * porcentaje / 100) + 3000

DROP FUNCTION IF EXISTS public.save_cliente_datos_correccion(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, NUMERIC, TEXT, NUMERIC);
...
COMMENT ON FUNCTION public.save_cliente_datos(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, public.cliente_datos_estado, NUMERIC, TEXT) IS
  'Asesor dueño guarda/actualiza cliente_datos. RFC opcional; cobro con monto calculado automático (+$3,000).';
