-- ConCasa CRM — Hotfix 151: primer alta cliente_datos en reingreso + gates de reenvío
-- Causa: expediente enviado sin fila cliente_datos; save_cliente_datos_correccion exigía fila;
-- save_cliente_datos bloqueaba INSERT post-Mesa; asesor_enviar_reingreso_a_mesa (143) subía
-- reingreso_manual_count sin checklist. No edita 119/143/150.
