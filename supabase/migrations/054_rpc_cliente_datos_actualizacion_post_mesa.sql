-- ConCasa CRM — P054: Datos Generales editables post-Mesa (sin exigir rechazo)
-- Recrea save_cliente_datos / save_cliente_datos_correccion desde P053 (Mejoravit + nombre/domicilio).
