-- ConCasa CRM — P090 B3: Pagaré (cliente_pagare) para Mesa
...
-- =============================================================================
-- A) Allowlist Mesa: agregar cliente_pagare
-- =============================================================================
...
COMMENT ON FUNCTION public.integration_doc_tipos_mesa_upload() IS
  'P030/P090: tipos que Mesa puede registrar vía register_mesa_documento (semanas, acta, SAT, pagaré). Opcionales; no son gate de avance.';
...
-- =============================================================================
-- B) MIME: imágenes solo para cliente_pagare (PDF/JPEG/PNG); resto intacto
-- =============================================================================
...
BEGIN
  ...
  -- Pagaré (P090): PDF (arriba) + JPEG/PNG únicamente
  IF v_tipo = 'cliente_pagare'
...
COMMENT ON FUNCTION public.expediente_documento_mime_permitido(TEXT, TEXT) IS
  'MIME permitido por tipo. PDF global. Pagaré: PDF/JPEG/PNG. INE/carta/acta digital: PDF+imágenes amplias. Acta/SAT/semanas Mesa: solo PDF.';
...
-- =============================================================================
-- C) register_mesa_documento: MIME por tipo + gate Pagaré etapa >= 7
-- =============================================================================
...
BEGIN
  ...
  -- P090: Pagaré solo desde etapa 7 (Notificación+). No aplica a otros tipos Mesa.
...
COMMENT ON FUNCTION public.register_mesa_documento(UUID, TEXT, TEXT, TEXT, TEXT, BIGINT) IS
  'P030/P090: Mesa registra metadata de complementarios (semanas/acta/SAT) y Pagaré (etapa>=7, PDF/JPEG/PNG). Soft-delete versionado. No es gate de avance.';
