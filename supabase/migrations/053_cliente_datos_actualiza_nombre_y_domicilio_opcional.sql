-- ConCasa CRM — P053: domicilio opcional + nombre Datos Generales → expedientes.cliente_nombre
-- Recrea save_cliente_datos desde P052. save_cliente_datos_correccion delega sin cambios de firma.
...
COMMENT ON FUNCTION public.save_cliente_datos(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, public.cliente_datos_estado, NUMERIC, TEXT, TEXT) IS
  'Asesor dueño guarda/actualiza cliente_datos. RFC opcional; domicilio opcional; nombre en p_datos actualiza expedientes.cliente_nombre; cobro automático (+$3,000); Mejoravit usa montoMejoravit o fallback −11% tope 169000.';
