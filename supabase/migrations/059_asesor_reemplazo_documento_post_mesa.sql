-- Post-Mesa: asesor puede reemplazar documentos ya registrados (sin reenviar expediente).
-- Mantiene bloqueo de creación de obligatorios faltantes y primer upload de opcional faltante (057).
...
COMMENT ON FUNCTION public.register_expediente_documento(UUID, TEXT, TEXT, TEXT, TEXT, BIGINT) IS
  'Registra documento asesor. Post-Mesa: reemplazo si ya existe; opcional faltante; bloquea obligatorio faltante.';
