-- ConCasa CRM — P195: Disponibles no incluye rechazo operativo activo.
-- Cloud max conocido = 194. 195 = este hotfix. Operación de citas → 196.
-- Solo read-model: mesa_list_bandeja_page. 0 tablas, 0 columnas, 0 backfill.
-- 0 writers (take/release/rechazar/reactivar/asignación intactos).
-- P192/P193 membership de vista rápida intacto (chip Rechazados sigue viendo activo+rechazado).
...
COMMENT ON FUNCTION public.mesa_list_bandeja_page(
  ...
  'P102/P166/P193 + P195: Disponibles (sin_asignar) exige ciclo activo y subestado <> rechazado. Sin writers.';
