-- ConCasa CRM — P2C-20 refinamiento avanzar_etapa_operativa 9→10 (migración 033)
-- Reemplaza función completa sin modificar 023 publicada: roles Mesa completos,
-- action_log/retorno con booking_date, booking_time, location_id; sin 10→11.
...
COMMENT ON FUNCTION public.avanzar_etapa_operativa(UUID, TEXT) IS
  'Mesa avanza expediente 1→2 … 8→9 o 9→10 (firmas; roles Mesa + super_admin). Otras transiciones no permitidas.';
