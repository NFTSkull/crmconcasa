-- ConCasa CRM — P119.4: Firmado → Pago a ConCasa (11→12)
-- Amplía avanzar_etapa_operativa_pre_reingreso con transición canónica 11_12.
-- No muta bookings, documentos, montos ni fecha_cita.
-- Roles: mesa_admin | mesa_interno | mesa_externo | super_admin (igual que el resto de la RPC).
...
COMMENT ON FUNCTION public.avanzar_etapa_operativa_pre_reingreso(UUID, TEXT) IS
  'P119.4: gates 1→…→10, 10→11 Firmado y 11→12 Pago a ConCasa.';
