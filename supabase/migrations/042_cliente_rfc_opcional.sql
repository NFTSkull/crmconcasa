-- ConCasa CRM — RFC opcional en datos generales del cliente
-- Reversible: restaurar bloque RFC obligatorio en save_cliente_datos y enviar_a_mesa.
...
COMMENT ON FUNCTION public.save_cliente_datos(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, public.cliente_datos_estado) IS
  'Asesor dueño guarda/actualiza cliente_datos. RFC opcional; si se envía, debe ser válido.';
...
COMMENT ON FUNCTION public.enviar_a_mesa(UUID) IS
  'Asesor dueño envía expediente a Mesa. Gates: editor aprobado+monto, cliente_datos completo, docs asesor.';
