-- ConCasa CRM — Reconciliación Production para Anette Perez.
--
-- La migración histórica 221_anette_perez_externa_equipo_silvia.sql existe en repo,
-- pero no estaba registrada/aplicada en Cloud. Eso dejaba a Anette con origen externo
-- pero fuera del Equipo Silvia, por lo que los documentos scoped de externos quedaban
-- ocultos/denegados.
--
-- Cambio mínimo e idempotente: activa únicamente la membresía de Anette en el único
-- Equipo Silvia Reyes activo de su organización. No modifica expedientes ni documentos.
