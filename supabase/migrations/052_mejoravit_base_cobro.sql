-- ConCasa CRM — P052: base cobro Mejoravit (−11%, tope 169000) en save_cliente_datos
-- No modifica 048/050 aplicadas. save_cliente_datos_correccion delega en save_cliente_datos.
...
BEGIN
  ...
  v_monto_calculado := round(v_base_cobro * v_porcentaje / 100 + 3000, 2);
...
COMMENT ON FUNCTION public.save_cliente_datos(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, public.cliente_datos_estado, NUMERIC, TEXT, TEXT) IS
  'Asesor dueño guarda/actualiza cliente_datos. RFC opcional; dirección obligatoria; cobro automático (+$3,000); Mejoravit usa base −11% tope 169000.';
