...
export const SOLICITUD_COVERAGE: FieldCoverageRow[] = [
  ...
  { document: "solicitud", page: 1, acroForm: SOLICITUD_FIELD.T31_BLANK, meaning: "% titulación (máx 30%)", crmSource: "ninguna (Mesa P0: no capturar)", transform: "ALWAYS_BLANK_FROM_MESA_CAPTURE", category: "E", filledIfSourceExists: false, emptyReason: "% titulación retirado de captura Mesa; layout PDF conserva campo vacío" },
  { document: "solicitud", page: 1, acroForm: SOLICITUD_FIELD.T32_BLANK, meaning: "CLABE notaría", crmSource: "ninguna (Mesa P0: no capturar)", transform: "ALWAYS_BLANK_FROM_MESA_CAPTURE", category: "E", filledIfSourceExists: false, emptyReason: "CLABE notaría retirada de captura Mesa; layout PDF conserva campo vacío" },
  { document: "solicitud", page: 1, acroForm: SOLICITUD_FIELD.T33_BLANK, meaning: "CLABE derechohabiente", crmSource: "destinoRecursos.clabeDerechohabiente (Mesa)", transform: "blankable", category: "A", filledIfSourceExists: true, emptyReason: "si Mesa no captura CLABE" },
