 ...
 * Mirror Edge de src/domain/agenda-sheets/time-aliases.ts
 */

export type AgendaSheetTimeAlias = {
  locationId: string;
  kind: string;
...
export type ParsedPhysicalSheetRowKey = {
  kind: string;
  bookingDate: string;
  logicalStartTime: string;
  locationId: string;
...
/** @deprecated Preferir buildPhysicalSheetRowKey. */
