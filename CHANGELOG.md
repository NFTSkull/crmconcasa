...
- **feat(mesa): P4B detección CLABE shadow desde Estado de cuenta** — texto embebido PDF (`extractPdfEmbeddedText`) + checksum P1 + contexto etiqueta; sugerencia visual sin autofill/DB/OCR/provider.
