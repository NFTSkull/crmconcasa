#!/usr/bin/env bash
# Runner aislado P163: mig 163 + admin_stage_history_calibrated_p163.sql
...
ISOLATED_DB="${ISOLATED_DB_NAME:-crm_p163_iso_$$}"
TMP_DIR="$(mktemp -d /tmp/crm-p163-XXXXXX)"
...
echo "==> Isolated P163 DB: ${ISOLATED_DB}"
...
echo "==> Running supabase/tests/admin_stage_history_calibrated_p163.sql"
psql_iso -f "supabase/tests/admin_stage_history_calibrated_p163.sql"

echo "P163 ALL PASSED"
