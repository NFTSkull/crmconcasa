#!/usr/bin/env bash
# Runner aislado B1.5 P161: mig 161 + rpc_asesor_inbox_page_p161.sql
...
ISOLATED_DB="${ISOLATED_DB_NAME:-crm_p161_iso_$$}"
TMP_DIR="$(mktemp -d /tmp/crm-p161-XXXXXX)"
...
echo "==> Isolated P161 DB: ${ISOLATED_DB}"
...
echo "==> Running supabase/tests/rpc_asesor_inbox_page_p161.sql"
psql_iso -f "supabase/tests/rpc_asesor_inbox_page_p161.sql"
echo "P161 asesor inbox SQL: ALL PASSED"
