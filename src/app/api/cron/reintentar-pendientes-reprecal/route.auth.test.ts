...
import { isAuthorizedCron } from "@/app/api/cron/reintentar-pendientes-reprecal/route";

describe("cron reintentar-pendientes-reprecal auth", () => {
  it("rechaza sin CRON_SECRET configurado", () => {
    const prev = process.env.CRON_SECRET;
    delete process.env.CRON_SECRET;
    try {
      const req = new Request(
        "http://localhost/api/cron/reintentar-pendientes-reprecal",
