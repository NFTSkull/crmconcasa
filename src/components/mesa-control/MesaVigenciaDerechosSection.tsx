...
export type MesaVigenciaDerechosSectionProps = Readonly<{
  expedienteId: string;
}>;
...
/**
 * Solo lectura: Mesa consulta Vigencia de derechos (sin upload/reemplazo/eliminar).
 * Preview únicamente para MIME seguros (PDF/JPG/PNG/WEBP).
 */
export function MesaVigenciaDerechosSection({
  expedienteId,
}: MesaVigenciaDerechosSectionProps) {
    ...
    >
      ...
      {!loading && !error && !documento ? (
        <p className="mt-2 text-sm text-gray-700">
          El asesor no ha cargado vigencia de derechos.
        </p>
      ) : null}
