...
- **P207.2 (LOCAL):** REPLACE `mesa_list_bandeja_page` + `mesa_bandeja_counts_fast` campo `disponibles`. Gate Disponibles = P207.1 ∧ `etapa_actual < 12` ∧ `pago_concasa_resultado IS NULL`. Quick filters / correccionesEnviadas / otrasActualizaciones **intactos**. 0 writers. Mig `20260901171420`. Sin Cloud aún.
